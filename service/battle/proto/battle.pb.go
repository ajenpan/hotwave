...
type GameMessageWrap_MSGID int32

const (
	GameMessageWrap_INVALID_MSGID GameMessageWrap_MSGID = 0
	GameMessageWrap_ID            GameMessageWrap_MSGID = 2004
)

// Enum value maps for GameMessageWrap_MSGID.
var (
	GameMessageWrap_MSGID_name = map[int32]string{
		0:    "INVALID_MSGID",
		2004: "ID",
	}
	GameMessageWrap_MSGID_value = map[string]int32{
		"INVALID_MSGID": 0,
		"ID":            2004,
	}
)

func (x GameMessageWrap_MSGID) Enum() *GameMessageWrap_MSGID {
	p := new(GameMessageWrap_MSGID)
	*p = x
	return p
}

func (x GameMessageWrap_MSGID) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (GameMessageWrap_MSGID) Descriptor() protoreflect.EnumDescriptor {
	return file_service_battle_proto_battle_proto_enumTypes[4].Descriptor()
}

func (GameMessageWrap_MSGID) Type() protoreflect.EnumType {
	return &file_service_battle_proto_battle_proto_enumTypes[4]
}

func (x GameMessageWrap_MSGID) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use GameMessageWrap_MSGID.Descriptor instead.
func (GameMessageWrap_MSGID) EnumDescriptor() ([]byte, []int) {
...
func (x *JoinBattleRequest) GetSeatId() int32 {
	if x != nil {
		return x.SeatId
	}
	return 0
...
func (x *JoinBattleResponse) GetSeatId() int32 {
	if x != nil {
		return x.SeatId
	}
	return 0
...
var file_service_battle_proto_battle_proto_rawDesc = []byte{
	...
	0x28, 0x05, 0x52, 0x06, 0x73, 0x65, 0x61, 0x74, 0x49, 0x64, 0x12, 0x1f, 0x0a, 0x0b, 0x72, 0x65,
	...
	0x49, 0x44, 0x10, 0xd3, 0x0f, 0x22, 0x7d, 0x0a, 0x0f, 0x47, 0x61, 0x6d, 0x65, 0x4d, 0x65, 0x73,
	0x73, 0x61, 0x67, 0x65, 0x57, 0x72, 0x61, 0x70, 0x12, 0x1b, 0x0a, 0x09, 0x62, 0x61, 0x74, 0x74,
	...
	0x20, 0x01, 0x28, 0x05, 0x52, 0x05, 0x6d, 0x73, 0x67, 0x69, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x64,
	...
	0x44, 0x10, 0xd4, 0x0f, 0x42, 0x08, 0x5a, 0x06, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x06,
...
var file_service_battle_proto_battle_proto_goTypes = []interface{}{
	...
	(GameMessageWrap_MSGID)(0),    // 4: battle.GameMessageWrap.MSGID
	...
	(*GameMessageWrap)(nil),       // 9: battle.GameMessageWrap
}
