...
// Users [...]
type Users struct {
	UID      int64     `gorm:"autoIncrement:true;primaryKey;column:uid;type:bigint;not null;comment:'用户唯一id'" json:"-"`          // 用户唯一id
	...
	UpdateAt time.Time `gorm:"column:update_at;type:datetime;default:null;comment:'修改时间'" json:"updateAt"`                       // 修改时间
}
